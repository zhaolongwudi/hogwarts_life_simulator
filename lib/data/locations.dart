...
const Map<String, String> kLocationParents = {
  ...
  '霍格沃茨·魔法史教室': '霍格沃茨·教室',
  '霍格沃茨·占卜教室': '霍格沃茨·教室',
  // 下面三条是同一条判据的直接推论，缺了它们就是 bug：
  // 判据是「子地点是某门课的**固定授课场所**，父地点是这些授课场所的统称」，
  // 与名字里有没有「教室」二字无关。魔药课固定在地窖、草药课固定在温室、
  // 天文学课固定在天文塔——玩家地点被归一成通用「霍格沃茨·教室」时，
  // 守在这三处的教授会从【在场】里集体消失，而这三处恰恰是三个主课场景
  // （第八次审查 P1-E）。
  '霍格沃茨·地窖': '霍格沃茨·教室',
  '霍格沃茨·温室': '霍格沃茨·教室',
  '霍格沃茨·天文塔': '霍格沃茨·教室',
