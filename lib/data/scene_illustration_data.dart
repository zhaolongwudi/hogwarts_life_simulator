...
// ============================================================================
// 【主题豁免声明 · Batch 8 Issue #16】
//
// 本文件内所有十六进制硬编码色值（0xFF 开头）均为「场景插图专用氛围渐变」，
// 每个场景（大礼堂/禁林/黑湖/斯内普办公室…）拥有独立配色，
// 用于营造地点专属视觉氛围，**不参与 AppColors/Theme 主题切换**。
//
// 豁免理由：
//   1. 场景插图是「地点 → 视觉氛围」的静态映射，与用户主题偏好无关；
//   2. 每个场景 3 色渐变（亮/中/暗）共 31 处，收敛到主题系统会引入
//      31 个新主题 token，收益远低于成本；
//   3. 场景插图不参与文字/按钮/背景等 UI 主题元素，无对比度合规风险。
//
// 若未来需要主题化，请：
//   - 在 AppColors 中新增 `sceneGradient` 系列 token；
//   - 同步更新本文件顶部豁免声明；
//   - 更新 test/batch8_scene_illustration_test.dart 的豁免检查。
// ============================================================================
