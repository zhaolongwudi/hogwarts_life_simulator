...
- 学年晋升：玩家与NPC年级推进、毕业离校、学年标签与学期划分
- 存档加固：原子写入 + 自动备份 + 损坏时回滚恢复
- 事件锚点：手写剧情骨架按月份/年级/时代注入叙事流程
- 开局特质：稀有度分级与软保底抽取，影响属性与叙事
- 职业目标数值化：为人生目标定义可衡量的毕业条件

### v1.2.0 — 2026-08-22

**📋 变更说明**
fix: 修复剧情文字颜色识别与地图大世界按钮

- 补全 _findDialogueColon/_speakerStart 等缺失函数，修正冒号对话检测
- 排除时间戳/日期/状态标签的误着色，正确标记说话人与台词
- 大世界按钮改为打开世界区域总览，不再向右切换地图
